    ...
    <div class="konten">
        <div class="filter-box" style="display: flex; flex-direction:column; gap:15px">
            ...
            <div class="form-filter">
                ...
                <button class="button btn-add">Cari</button>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>RSV-20250601-01</td>
                    <td>Lina Kurniawati</td>
                    <td>Gunung Gede</td>
                    <td>10-06-2025</td>
                    <td>Menunggu</td>
                    <td>
                        <button class="button btn-reset">Detail</button>
                    </td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>RSV-20250530-02</td>
                    <td>Irfan Saputra</td>
                ...
                <tr>
                    <td>3</td>
                    <td>RSV-20250528-03</td>
                    <td>Bayu Firmansyah</td>
                    <td>Gunung Padang</td>
                    <td>02-06-2025</td>
                    <td>Ditolak</td>
                    <td>
                        <button class="button btn-edit">Alasan</button>
                    </td>
                </tr>
            </tbody>
        </table>
